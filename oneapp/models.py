...
class NewsSection(models.Model):
    parent = models.ForeignKey(News,on_delete=models.CASCADE,related_name='news_sections')
...
class EventSection(models.Model):
    parent = models.ForeignKey(Event,on_delete=models.CASCADE,related_name='event_sections')
    title = models.CharField(max_length=500)
    description = models.TextField()
    image = models.ImageField(null=True,blank=True)
